...
<html lang="en">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-dark bg-dark">
               <a class="logo" href="index.html"><img src="{{ asset('/') }}assets2/images/logo.png"></a>
                  ...
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="{{ asset('/') }}assets2/images/img-1.png" class="image_1"></div>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section active">
                     ...
                     <div><img src="{{ asset('/') }}assets2/images/img-2.png" class="image_2"></div>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{ asset('/') }}assets2/images/img-3.png" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{ asset('/') }}assets2/images/img-4.png" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beauty_box">
                     ...
                     <div><img src="{{ asset('/') }}assets2/images/img-5.png" class="image_3"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
               <div class="col-lg-8 col-sm-12">
                  <div class="beauty_box_1">
                     ...
                     <div><img src="{{ asset('/') }}assets2/images/img-6.png" class="image_3"></div>
      ...
      <script>window.jQuery || document.write('<script src="{{ asset('/') }}assets2/js/vendor/jquery-slim.min.js"><\/script>')</script>
